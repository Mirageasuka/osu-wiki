...
# ศูนย์ช่วยเหลือทางด้านทัวร์นาเม้นต์

ทีมงาน [osu! team](/wiki/People/The_Team) runs a program where they may opt to provide community-run tournaments that abide by a certain set of criteria and expectations with extra support, at their discretion.
...
ทัวร์นาเม้นต์ที่ได้รับการช่วยเหลือนั้นจะ:

- สามารถ [ตรวจสอบผู้เล่น](#tournament-screening) เพื่อป้องกันไม่ให้ผู้เล่นที่กระทำความผิดร้ายแรงนั้น (การโกงโดยใช้โปรแกรมช่วยเล่น, หลายบัญชี, การโดนแบนจากทัวร์นาเม้นต์) เข้าร่วมการแข่งขัน
- [เหรียญตราบนหน้าโปรไฟล์](#profile-badges) สำหรับผู้ชนะการแข่งขัน
- สิทธิ์ที่จะสามารถขอ [เบนเนอร์ในหน้าเริ่มเกม](#requesting-main-menu-banner-support) ในระหว่างการแข่งขันในคู่เด่น

## กฏเกณฑ์

ทัวร์นาเม้นต์ที่ดูแลโดยชุมชุนจะต้องอยู่ภายใต้กฏเกณฑ์ดังต่อไปนี้:

- ทัวร์นาเม้นต์ที่มีการแข่งขันไม่เกิน 4 ครั้งต่อปี
- ทัวร์นาเม้นต์จะต้องมีการดำเนินการแข่งขันอย่างน้อยตั้งแต่รอบ 16 คนสุดท้าย ในกฏ แพ้สองครั้งคัดออก **หรือ** มีผู้สมัครไม่ต่ำกว่า 64 คน (สำหรับทีมคือ 16 ทีม) หากมีจำนวนคนหรือทีมที่เยอะกว่าที่กำหนด
- ทัวร์นาเม้นท์ที่จัดขึ้นและดำเนินงานโดย *ทีมงานที่มีประสบการณ์และมาตรฐานในระดับนึง**¹*** , **หรือ**, ทัวร์นาเม้นต์ที่ *ดำเนินมาแล้วอย่างน้อยหนึ่งครั้งโดยไม่มีเงินรางวัล*.
- ทีมงานจะไม่สามารถลงการแข่งขันทัวร์นาเม้นต์ในทุกกรณี และ ผู้เล่นไม่สามารถเข้ามาเป็นทีมงานได้ในภายหลัง. คำจำกัดความของ "ทีมงาน" สำหรับพวกเรานั้น กรุณาอ่านที่ [FAQ](#what-is-considered-staff).
- กระทู้ของทัวร์นาเม้นต์นั้น**จะต้อง**มีลิ้งค์ที่เกี่ยวข้องกับทัวร์นาเม้นต์ในขนาดตัวอักษรปกติไปยัง [แบบฟอร์มรายงานทัวร์นาเม้นต์](https://pif.ephemeral.ink/tournament-reports) โดยจะนับการแก้ไขกระทู้ในครั้งล่าสุด
  - `https://pif.ephemeral.ink/tournament-reports`
  - แบบฟอร์มดังกล่าวจะถูกตรวจสอบโดย [คณะกรรมการด้านทัวร์นาเม้นต์](/wiki/People/Tournament_Committee). เราแนะนำให้ผู้เล่นทุกท่าน หรือ ทีมงาน ใช้แบบฟอร์มดังกล่าวเพื่อรายงานทัวร์นาเม้นต์ที่ได้รับการช่วยเหลือจากเรา

**¹**: ทีมงานที่มี "ประสบการณ์" คือคนที่ได้ช่วยเหลือทัวร์นาเม้นต์อย่างสม่ำเสมอและดูแลทัวร์นาเม้นต์ที่มีเหรียญตราไม่ต่ำกว่า **สาม** ครั้ง หรือ ได้เป็นส่วนหนึ่งของทีมงาน World Cup ในทุกโหมดการแข่งขัน ซึ่งการตัดสินจะขึ้นอยู่กับดุลยพินิจของทีมงานทางด้านบัญชีทั้งสิ้น

## การขอรับการสนับสนุน

โดยการขอรับการสนับสนุนนั้น **จะต้องจัดระบบให้ดีก่อนการขอรับการสนับสนุน** โดยจะไม่มีระยะเวลาที่แน่ชัด แต่เราแนะนำอย่างน้อย 2 ถึง 3 อาทิตย์ ก่อนเวลาการแข่งขันเพื่อเผื่อเวลาสำหรับการตรวจสอบผู้เล่น

หากทัวร์นาเม้นต์ของคุณ [ได้ผ่านกฏเกณฑ์](#eligibility) ดังกล่าวแล้ว คุณสามารถส่งคำร้องขอการขอรับการสนับสนุนผ่านอีเมล์ [tournaments@ppy.sh](mailto:tournaments@ppy.sh) โดยจะต้องมีข้อมูลดังต่อไปนี้:

- รายละเอียดตร่าวๆ ของทัวร์นาเม้นต์ของคุณ รวมไปถึงช่วงระยะเวลาในการแข่งขัน, โหมดที่ใช้ในการแข่งขัน หรือ สิ่งที่เกี่ยวข้องกับทัวร์นาเม้นต์
- ลิ้งค์ที่จะเชื่อมไปยัง:
  - กระทู้ของทัวร์นาเม้นต์ใน [Tournaments forum](https://osu.ppy.sh/community/forums/55) ที่ได้ประกาศข้อมูลเกี่ยวกับทัวร์นาเม้นต์ของคุณ
    - สำหรับทัวร์นาเม้นต์ระดับประเทศ สามารถสร้างกระทู้ในภาษานั้น ๆ ได้ ในกระทู้
  - ดิสคอร์ดเซิฟเวอร์ของทัวร์นาเม้นต์ หรือ อาจจะเป็นเซิฟเวอร์อื่น ๆ ที่มีห้องพูดคุยใช้าำหรับการแข่งขัน
  - ทัวร์นาเม้นต์ครั้งที่แล้วในชื่อเดียวกัน (เฉพาะครั้งที่สามารถร้องขอได้)
- นอกเหนือจากนั้น:
  - รายชื่อทีมงานและผู้ช่วยที่เกี่ยวข้องกับการดำเนินทัวร์นาเม้นต์ (ดูได้ที่ [FAQ](#what-is-considered-staff)).
  - รายชื่อผู้เล่นที่ได้ลงทะเบียนการแข่งขัน (ดูได้ที่ [การตรวจสอบผู้เล่น](#tournament-screening)).

หลังจากที่เราได้รับคำร้องขอในการขอรับการสนับสนุนแล้ว ทางทีมงานฝ่ายบัญชีจะตอบกลับพร้อมกับรายชื่อผู้เล่นที่สามารถลงการแข่งขันได้ โปรดให้เวลาในการตอบกลับสักนิดนึง เราจะพยายามจะทำให้เสร็จภายในระยะเวลาหนึ่งอาทิตย์ ในบางครั้งเรามีภาระงานที่เยอะ มันก็เลยเป็นการยากที่จะทำให้มันเสร็จภายในหนึ่งอาทิตย์
